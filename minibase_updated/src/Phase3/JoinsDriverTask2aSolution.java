...
public class JoinsDriverTask2aSolution implements GlobalConst{
	...
	private FldSpec[] joinFields = new FldSpec[4];
	private Heapfile qHeapfile = null;
	private int qTupleSize = 1024;
	private IESelfJoin sjtp = null;
	 ...
	 */
	public JoinsDriverTask2aSolution(String QFilePath, String QueryFilePath)
			throws FileNotFoundException {
		boolean status = OK;
		// Q in Task2b.
	...
	public void QueryTask2b() {
		...
		try {
			sjtp = new IESelfJoin(qAttrTypes, 4, null, 10, "Q.in", queryConfiguration,
