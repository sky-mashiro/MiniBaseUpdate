...
public class JoinsDriverTask2dSolutionb implements GlobalConst{
	 ...
	 */
	public JoinsDriverTask2dSolutionb(String QFilePath)
			throws FileNotFoundException {
		boolean status = OK;
		// Q in Task2b.
	...
	public void QueryTask2b() {
		...
		setTask2bQueryCondExpr(queryConfiguration,queryConfiguration2);
...
//			System.out.println("2#:"+nlj.get_next());
	...
	private void setTask2bQueryCondExpr(CondExpr[] expr, CondExpr[] expr2) {
