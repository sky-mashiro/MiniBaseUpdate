...
public class Task2dSolutiona {
	public static void main(String argv[]) throws FileNotFoundException {
		...
		boolean status;
		JoinsDriverTask2dSolutiona joinsDriverTask2dSolutiona = new JoinsDriverTask2dSolutiona(
				"src/tests/Q2000.txt");
		status = joinsDriverTask2dSolutiona.runTests();
		if (status != true) {
