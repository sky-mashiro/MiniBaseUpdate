...
public class IEJoinWithTwoPredicatesTask2d extends Iterator{
	   ...
	   */
	public IEJoinWithTwoPredicatesTask2d(AttrType in1[], int len_in1, short t1_str_sizes[],
...
//		}
	...
	public Tuple get_next() throws IOException, JoinsException, IndexException, InvalidTupleSizeException,
		...
		do{
			...
			int [] o1 = new int[indexR2+1];
			int [] o2 = new int[indexR2+1];
			...
			for(int i = 0; i<=indexR1;i++){
				...
				if(bIndex[i] == 1)
				{
					if(off1>=0 && off1<b.length){
						for(int k=off1+eqOff;k<=indexS2;k++){
							if(b[k]==1){
