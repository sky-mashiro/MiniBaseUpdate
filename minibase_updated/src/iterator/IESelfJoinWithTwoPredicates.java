...
public class IESelfJoinWithTwoPredicates extends Iterator{
	   ...
	   */
	public IESelfJoinWithTwoPredicates(AttrType in1[], int len_in1, short t1_str_sizes[], int amt_of_mem,
